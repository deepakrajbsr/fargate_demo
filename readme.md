...
- Main class com.demo.rest.webservices.restfulwebservices.RestfulWebServicesApplication 
...
- mvn clean package
- docker run --publish 8200:80 demo/aws-hello-world-rest-api:0.0.1-SNAPSHOT
...
- http://localhost:8200/hello-world/path-variable/demo
